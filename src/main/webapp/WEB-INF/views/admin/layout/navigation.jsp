...
<ul class="nav nav-list">
  ...
  <li><a href="<c:url value='/admin/page'/>">所有页面</a></li>
  <li><a href="<c:url value='/admin/page/create'/>">添加</a></li>
  ...
  <li><a href="<c:url value='/admin/user'/>">所有用户</a></li>
  <li><a href="<c:url value='/admin/role'/>">用户组</a></li>  
